...
Unlike patchwork and cowplot, customLayout works with base R graphics.

```{r customlayout-base, fig.width=8, fig.height=6}
lay <- lay_new(matrix(1:4, nrow = 2))
lay_set(lay)

# Base graphics plots
set.seed(123)
plot(rnorm(50), main = "Scatter Plot")
hist(rnorm(100), main = "Histogram")
boxplot(rnorm(50) ~ sample(1:2, 50, replace = TRUE), main = "Boxplot")
barplot(table(sample(1:3, 50, replace = TRUE)), main = "Barplot")
```
